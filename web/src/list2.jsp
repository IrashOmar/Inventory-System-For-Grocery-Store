...
<body>
          ...
          <div class="d-flex align-items-center flex-wrap flex-sm-nowrap justify-content-between">
              ...
              <ul class="navbar-nav order-3 order-sm-4 ms-3 mb-2 mb-md-0 d-flex flex-row">
                  <li class="nav-item mx-1">
                      <a href="../src/user.html" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                      </svg></a>
                  </li>
                  <li class="nav-item mx-1">
                    <a href="../src/list2.html" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cash" viewBox="0 0 16 16">
                        <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                        <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
                      </svg></a>
                  </li>
                  <li class="nav-item mx-1">
                      <a href="../src/cart.html" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-basket2" viewBox="0 0 16 16">
  ...
  <nav class="navbar sticky-top navbar-expand-sm shadow py-2 justify-content-center"
      ...
      <div class="collapse navbar-collapse" id="categoriesToggle">
          <div class="container">
              <ul class="navbar-nav mb-2 mb-md-0 w-100 justify-content-between next" style="font-weight: bold;">
                  ...
                  <li class="nav-item"><a href="/src/products.html" class="nav-link text-dark">Food Essentials</a></li>
    ...
    <div class="container" style="background-color: white;">
      ...
      <div class="row mt-3 mb-5" style="background-color: #e48342;">
        <h3 style="text-align: center;" class="py-3 rounded-3">Wishlist</h3>
            ...
            <div class="row mb-3">
              <div class="col-2">
                ...
                <div class="edit" style="margin-left: 115px; margin-top: 7px;">
              ...
              <div class="col-2">
                <div class="edit" style="margin-left: 35px; margin-top: 7px;">
                  <button type="button" class="btn btn-outline-danger buttonsquare" style="border-radius: 25px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                      <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                      <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                    </svg>
            ...
            <div class="row">
              <div class="center m-3">
                  <button type="button" class="btn btn-outline-success" id="buttonmodal" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="width: 30%;">
