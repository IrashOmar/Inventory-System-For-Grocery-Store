...
String sql ="select * from owner_details where id="+id;
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>

<h1></h1>
<form method="post" action="cubaEdit.jsp">
        ...
        <div class="container-lg py-3" style="background-color:white;">
            <div class="row">
                ...
                <div class="col-sm-9 py-2">
                   ...
                   <div class="mb-3">
                        <label class="col-auto">No of User</label>
                        <input name="id" value='<%=resultSet.getString("id") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                    <div class="mb-3">
                        <label class="col-auto">Username</label>
                        <input name="Username" value='<%=resultSet.getString("Username") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                    <div class="mb-3">
                        <label class="col-auto">Name</label>
                        <input name="Name" value='<%=resultSet.getString("Name") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                        <div class="mb-3">
                        <label class="col-auto">Gender</label>
                        <input name="Gender" value='<%=resultSet.getString("Gender") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                       <div class="mb-3">
                        <label class="col-auto">Email</label>
                        <input name="Email" value='<%=resultSet.getString("Email") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                       <div class="mb-3">
                        <label class="col-auto">Address</label>
                        <input name="Address" value='<%=resultSet.getString("Address") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                       <div class="mb-3">
                        <label class="col-auto">Phone Number</label>
                        <input name="no" value='<%=resultSet.getString("no") %>' type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                       </div>
