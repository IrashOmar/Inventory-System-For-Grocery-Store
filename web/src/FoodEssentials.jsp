            ...
            <div class="card-body m-3 mt-2">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3">
                    <div class="col">
                        <div class="card shadow-sm sshighlight">
                            <a href="../products-closeup.jsp">
                                <img src="../imgfood/FoodEssentials/maggi.JPG" alt="pise" class="card-img-top">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm sshighlight">
                            <a href="../products-closeup.jsp">
                                <img src="../imgfood/FoodEssentials/Beras.JPG" alt="pise" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">Beras Basmathi</h5>
                                <p class="card-text">RM 9999.99</p>
                                <div class="d-flex flex-sm-column justify-content-around">
                    ...
                    <div class="col">
                        <div class="card shadow-sm sshighlight">
                            <a href="./products-closeup.jsp">
                                <img src="../imgfood/FoodEssentials/Mayo.JPG" alt="pise" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">Mayonese</h5>
                                <p class="card-text">RM 9999.99</p>
                                <div class="d-flex flex-sm-column justify-content-around">
                                    <a href="#" class="btn btn-success rounded-pill mb-sm-2">View Details</a>
                                    <a href="#" class="btn btn-warning rounded-pill">Add to Cart</a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm sshighlight">
                            <a href="./products-closeup.jsp">
                                <img src="../imgfood/FoodEssentials/sos.JPG" alt="pise" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">Chilli Sauce</h5>
                                <p class="card-text">RM 9999.99</p>
                                <div class="d-flex flex-sm-column justify-content-around">
                                    <a href="#" class="btn btn-success rounded-pill mb-sm-2">View Details</a>
                                    <a href="#" class="btn btn-warning rounded-pill">Add to Cart</a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm sshighlight">
                            <a href="./products-closeup.jsp">
                                <img src="../imgfood/FoodEssentials/spaghetti.JPG" alt="pise" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">Spagehtti</h5>
                                <p class="card-text">RM 9999.99</p>
                                <div class="d-flex flex-sm-column justify-content-around">
                                    <a href="#" class="btn btn-success rounded-pill mb-sm-2">View Details</a>
                                    <a href="#" class="btn btn-warning rounded-pill">Add to Cart</a>
