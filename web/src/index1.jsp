...
<div class="row g-3 py-2">
                            <div class="col-md-3">
                                <label for="labelName" class="col-form-label"><strong>No User</strong></label>
                            </div>
                            <div class="col-md-3 offset-md-2">
                                <label for="id" class="col-form-label"><%=resultSet.getString("id") %></label>
                            </div>
                        </div>
                        <div class="row g-3 py-2">
                            <div class="col-md-3">
                        ...
                        <div class="row g-3 py-2">
                            <div class="col-md-3">
                                <label for="labelEmail" class="col-form-label"><strong>Name</strong></label>
                            </div>
                            <div class="col-md-3 offset-md-2">
                        ...
                        <div class="row g-3 py-2">
                            <div class="col-md-3">
                                <label for="labelPhone" class="col-form-label"><strong>Gender</strong></label>
                            </div>
                            <div class="col-md-3 offset-md-2">
                                <label for="Gender" class="col-form-label"><%=resultSet.getString("Gender") %></label>
                            </div>
                        </div>
                        <div class="row g-3 py-2">
                              <div class="col-md-3">
                                <label for="labelGender" class="col-form-label"><strong>Email</strong></label>
                            </div>
                            <div class="col-md-3 offset-md-2">
                                ...
                                <div class="row g-3 py-2">
                              <div class="col-md-3">
                                <label for="labelGender" class="col-form-label"><strong>Address</strong></label>
                            </div>
                            <div class="col-md-3 offset-md-2">
                                <label for="Address" class="col-form-label"><%=resultSet.getString("Address") %></label>
                            </div>
                             </div>
                                <div class="row g-3 py-2">
                              <div class="col-md-3">
                                <label for="labelGender" class="col-form-label"><strong>Phone Number</strong></label>
                            </div>
                            <div class="col-md-3 offset-md-2">
                                <label for="no" class="col-form-label"><%=resultSet.getString("no")%></label>
                            </div>
                             </div>

                              <a href="cuba1.jsp?id=<%=resultSet.getString("id")%>" class="btn btn-warning">Edit</a><!-- comment -->
