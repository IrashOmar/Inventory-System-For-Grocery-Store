        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <form method="post"  action="FileUploadServlet"  enctype ="multipart/form-data">
                     <div class="container">
                    <div class="mb-3">
                        <select name="category" class="form-select" style="border-radius: 5px 5px 5px 5px;">
                    ...
                    <div class=" mb-3">
                        ...
                        <input name="name" type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                    <div class="mb-3">
                        <label class="col-auto">Supplier</label>
                        <input name="supplier" type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                    <div class="mb-3">
                        <label class="col-auto">Product Price</label>
                        <input name="price" type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                      <div class="mb-3">
                        <label class="col-auto">Product Quantity</label>
                        <input name="quantity" type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                        <div class="mb-3">
                        <label class="col-auto">Product Description</label>
                        <input name="description" type="text" class="form-control" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                      <div class="mb-3">
