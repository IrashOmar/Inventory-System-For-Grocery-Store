<%-- 
    Document   : index
    Created on : May 28, 2021, 9:16:05 PM
    Author     : User
--%>
...
<body>
    ...
    <button type="button" class="btn rounded-circle" id="scrollUp" onclick="goUp()">
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="46" fill="currentColor" class="bi bi-caret-up-fill"
            viewBox="0 0 16 16">
            <path
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" style="height:fit-content;">
            <div class="carousel-item active">
                <img src="img/Irash.png" class="d-block w-100" alt="...">
            </div>
    ...
    <div class="cardIndex">
        <div class="container">
            <div class="d-flex flex-row align-items-center py-3  gap-3">
                <h2 class="mt-1">ALL PRODUCTS</h2>
               
                <a href="src/products.jsp" class="btn btn-success rounded-pill mb-sm-2">View Inventory</a>
